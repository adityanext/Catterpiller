...
class PaymentAdapter(
    ...
    private val mcontext: Context, private val balanceModeArrayList: ArrayList<PaymentModel>, var clickAdapter: ClickPaymentAdapter) : RecyclerView.Adapter<PaymentAdapter.ViewHolder>() {
