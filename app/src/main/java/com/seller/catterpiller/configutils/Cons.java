...
public class Cons {
    ...
    public static String SERVERURL = "https://www.samsung.com/in/aboutsamsung/";
//    public static String SERVERURL = "http://11dreamer.com/11dreamer/";
    ...
    //APK URL
    public static String APKURL = SERVERURL+"apk/YoPlay.apk";
//    public static String APKURL = SERVERURL+"apk/11dreamer.apk";
    //APK NAME
    public static String APKNAME = "YoPlay.apk";
//    public static String APKNAME = "11dreamer.apk";
    ...
    public static String ABOUTUSURL = SERVERURL+"home/";
...
//    public static String FORGOTPASSWORD = "http://yoplay.online/application/modulesuser/myrestforget_password";
